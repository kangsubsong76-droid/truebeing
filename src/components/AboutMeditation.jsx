    ...
    return (
        <div className="pt-24 pb-20 bg-white">
            ...
            <section className="bg-meditation-900 text-white py-20 rounded-3xl container mx-auto px-6 max-w-5xl text-center">
                ...
                <p className="text-xl text-meditation-100 leading-relaxed max-w-3xl mx-auto mb-10 font-light">
                    올바른 명상은 잠깐의 기분 전환이 아닙니다.<br />
                    에고(Ego)의 소멸이 이루어지고 있는 상태, <br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto">
                    <div className="bg-meditation-800 p-6 rounded-xl">
                        ...
                        <p className="text-meditation-200 text-sm">순간순간 일어나는 마음의 작용을 있는 그대로 관찰하고 깨어있습니다.</p>
                    </div>
                    <div className="bg-meditation-800 p-6 rounded-xl">
                        <h3 className="font-bold text-lg mb-3">2. 몰입 (Samadhi)</h3>
                        <p className="text-meditation-200 text-sm">대상을 향한 흔들림 없는 집중을 통해 깊은 내면의 고요에 도달합니다.</p>
                    </div>
                    <div className="bg-meditation-800 p-6 rounded-xl">
                        <h3 className="font-bold text-lg mb-3">3. 통찰 (Panna)</h3>
                        <p className="text-meditation-200 text-sm">현상의 본질을 꿰뚫어 보고 마음의 속박으로부터 자유로워집니다.</p>
                    </div>
                </div>
            </section>
        </div>
